...
Visualise the distribution of `years_to_unicorn`.
...
```{r}
print(paste("Pearson correlation: ", pearson_val))
print(paste("Spearman correlation: ", spearman_val))
```

Visualising the correlation between `valuation` and `funding`.
